...
--
-- Host: localhost    Database: naviera_db
-- ------------------------------------------------------
...
CREATE TABLE `travels` (
  ...
  `passengersLimit` int unsigned NOT NULL,
  `availableSeatsNumber` int unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-02-27 17:58:25
